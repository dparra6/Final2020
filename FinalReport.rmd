...
effectiveness = galsfish$estimate/(galsfish$estimate +1)
print(effectiveness*100)
```
...
effectiveness = gaysfish$estimate/(gaysfish$estimate +1)
print(effectiveness*100)
```
...
effectiveness = drugfish$estimate/(drugfish$estimate +1)
print(effectiveness*100)
```
